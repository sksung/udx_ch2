...
public class ti_xdais_utils_trace_cio
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            ...
            sb.append("'lib/debug/cioTrace.abnc',\n");
            sb.append("'lib/release/cioTrace.abnc',\n");
            sb.append("'lib/debug/cioTrace.a470uC',\n");
            sb.append("'lib/release/cioTrace.a470uC',\n");
            sb.append("'lib/debug/cioTrace.av4TCE',\n");
            sb.append("'lib/release/cioTrace.av4TCE',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            ...
            sb.append("['lib/debug/cioTrace.abnc', {target: 'google.targets.arm.Bionic', suffix: 'bnc'}],\n");
            sb.append("['lib/release/cioTrace.abnc', {target: 'google.targets.arm.Bionic', suffix: 'bnc'}],\n");
            ...
            sb.append("['lib/debug/cioTrace.av4TCE', {target: 'microsoft.targets.arm.WinCE', suffix: 'v4TCE'}],\n");
            sb.append("['lib/release/cioTrace.av4TCE', {target: 'microsoft.targets.arm.WinCE', suffix: 'v4TCE'}],\n");
        sb.append("];\n");
