...
public class ti_xdais_dm_examples_universal_copy
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            ...
            sb.append("'lib/debug/universal_copy.abnc',\n");
            sb.append("'lib/debug/universal_copy_trace.abnc',\n");
            sb.append("'lib/release/universal_copy.abnc',\n");
            sb.append("'lib/release/universal_copy_trace.abnc',\n");
            ...
            sb.append("'lib/debug/universal_copy.av4TCE',\n");
            sb.append("'lib/debug/universal_copy_trace.av4TCE',\n");
            sb.append("'lib/release/universal_copy.av4TCE',\n");
            sb.append("'lib/release/universal_copy_trace.av4TCE',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            ...
            sb.append("['lib/debug/universal_copy.abnc', {target: 'google.targets.arm.Bionic', suffix: 'bnc'}],\n");
            sb.append("['lib/debug/universal_copy_trace.abnc', {target: 'google.targets.arm.Bionic', suffix: 'bnc'}],\n");
            sb.append("['lib/release/universal_copy.abnc', {target: 'google.targets.arm.Bionic', suffix: 'bnc'}],\n");
            sb.append("['lib/release/universal_copy_trace.abnc', {target: 'google.targets.arm.Bionic', suffix: 'bnc'}],\n");
            ...
            sb.append("['lib/debug/universal_copy.av4TCE', {target: 'microsoft.targets.arm.WinCE', suffix: 'v4TCE'}],\n");
            sb.append("['lib/debug/universal_copy_trace.av4TCE', {target: 'microsoft.targets.arm.WinCE', suffix: 'v4TCE'}],\n");
            sb.append("['lib/release/universal_copy.av4TCE', {target: 'microsoft.targets.arm.WinCE', suffix: 'v4TCE'}],\n");
            sb.append("['lib/release/universal_copy_trace.av4TCE', {target: 'microsoft.targets.arm.WinCE', suffix: 'v4TCE'}],\n");
        sb.append("];\n");
