...
public class ti_xdais_dm_examples_videnc2_copy
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            ...
            sb.append("'lib/debug/videnc2_copy.abnc',\n");
            sb.append("'lib/release/videnc2_copy.abnc',\n");
            sb.append("'lib/debug/videnc2_copy.a470uC',\n");
            sb.append("'lib/release/videnc2_copy.a470uC',\n");
            sb.append("'lib/debug/videnc2_copy.av4TCE',\n");
            sb.append("'lib/release/videnc2_copy.av4TCE',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            ...
            sb.append("['lib/debug/videnc2_copy.abnc', {target: 'google.targets.arm.Bionic', suffix: 'bnc'}],\n");
            sb.append("['lib/release/videnc2_copy.abnc', {target: 'google.targets.arm.Bionic', suffix: 'bnc'}],\n");
            ...
            sb.append("['lib/debug/videnc2_copy.av4TCE', {target: 'microsoft.targets.arm.WinCE', suffix: 'v4TCE'}],\n");
            sb.append("['lib/release/videnc2_copy.av4TCE', {target: 'microsoft.targets.arm.WinCE', suffix: 'v4TCE'}],\n");
        sb.append("];\n");
