...
#ifndef ti_sdo_utils_loggers_LogMFP__INTERNAL__
#define ti_sdo_utils_loggers_LogMFP__INTERNAL__

#ifndef ti_sdo_utils_loggers_LogMFP__internalaccess
#define ti_sdo_utils_loggers_LogMFP__internalaccess
#endif
...
/* control */
#undef ti_sdo_utils_loggers_LogMFP_control
#define ti_sdo_utils_loggers_LogMFP_control ti_sdo_utils_loggers_LogMFP_control__F

/* Module_startup */
#undef ti_sdo_utils_loggers_LogMFP_Module_startup
#define ti_sdo_utils_loggers_LogMFP_Module_startup ti_sdo_utils_loggers_LogMFP_Module_startup__F

/* Instance_init */
#undef ti_sdo_utils_loggers_LogMFP_Instance_init
#define ti_sdo_utils_loggers_LogMFP_Instance_init ti_sdo_utils_loggers_LogMFP_Instance_init__F

/* Instance_finalize */
#undef ti_sdo_utils_loggers_LogMFP_Instance_finalize
#define ti_sdo_utils_loggers_LogMFP_Instance_finalize ti_sdo_utils_loggers_LogMFP_Instance_finalize__F
...
#endif /* ti_sdo_utils_loggers_LogMFP__INTERNAL____ */
