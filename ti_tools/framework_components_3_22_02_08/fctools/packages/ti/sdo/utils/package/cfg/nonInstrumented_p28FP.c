 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = /db/vtree/library/trees/ipc/ipc-h27/src/ti/sdo/utils/package/cfg/nonInstrumented_p28FP");
 ...
 */
xdc__META(__PLAT__, "@(#)__PLAT__ = ti.platforms.concertoC28");
