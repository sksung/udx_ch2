 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = /db/atree/library/trees/osal/osal-e09/src/linuxdist/preconfig/production/configPkg_v5T/package/cfg/preConfig_pv5T");
...
/*
 *  @(#) linuxdist; 1, 0, 0,1; 2-15-2012 07:46:13; /db/atree/library/trees/osal/osal-e09/src/ xlibrary
