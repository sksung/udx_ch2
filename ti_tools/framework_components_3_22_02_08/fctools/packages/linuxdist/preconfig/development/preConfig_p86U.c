 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = /db/atree/library/trees/osal/osal-e09/src/linuxdist/preconfig/development/configPkg_86U/package/cfg/preConfig_p86U");
...
/*
 *  @(#) linuxdist; 1, 0, 0,1; 2-15-2012 07:46:10; /db/atree/library/trees/osal/osal-e09/src/ xlibrary
