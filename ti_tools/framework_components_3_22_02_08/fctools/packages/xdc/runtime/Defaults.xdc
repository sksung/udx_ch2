...
module Defaults {
     ...
     *  support.
     *
     *  Modules for which the attribute NoRuntime is set do not use any
     *  functionality controlled by the parameters in their `common$`
     *  structures. For such modules, these parameters are set to the
     *  following values, and cannot be changed, to guarantee that NoRuntime
     *  modules do not accidentally request functionality they don not use.
     */
...
/*
 *  @(#) xdc.runtime; 2, 1, 0,371; 2-10-2012 10:18:54; /db/ztree/library/trees/xdc/xdc-y21x/src/packages/
 */
