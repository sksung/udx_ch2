...
public class ti_sdo_utils_trace
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            ...
            sb.append("'lib/debug/gt.ae64P',\n");
            sb.append("'lib/release/gt.ae64P',\n");
            sb.append("'lib/debug/gt.ae64T',\n");
            sb.append("'lib/release/gt.ae64T',\n");
            sb.append("'lib/debug/gt.ae674',\n");
            sb.append("'lib/release/gt.ae674',\n");
            sb.append("'lib/debug/gt.aearp32',\n");
            sb.append("'lib/release/gt.aearp32',\n");
            sb.append("'lib/debug/gt.a86U',\n");
            sb.append("'lib/release/gt.a86U',\n");
            sb.append("'lib/debug/gt.av5T',\n");
            sb.append("'lib/release/gt.av5T',\n");
            sb.append("'lib/debug/gt.abnc',\n");
            sb.append("'lib/release/gt.abnc',\n");
            sb.append("'lib/debug/gt.a470uC',\n");
            sb.append("'lib/release/gt.a470uC',\n");
            sb.append("'lib/debug/gt.aem3',\n");
            sb.append("'lib/release/gt.aem3',\n");
            sb.append("'lib/debug/gt.aea8f',\n");
            sb.append("'lib/release/gt.aea8f',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/gt.a64P', {target: 'ti.targets.C64P', suffix: '64P'}],\n");
            sb.append("['lib/release/gt.a64P', {target: 'ti.targets.C64P', suffix: '64P'}],\n");
            sb.append("['lib/debug/gt.a674', {target: 'ti.targets.C674', suffix: '674'}],\n");
            sb.append("['lib/release/gt.a674', {target: 'ti.targets.C674', suffix: '674'}],\n");
            sb.append("['lib/debug/gt.ae64P', {target: 'ti.targets.elf.C64P', suffix: 'e64P'}],\n");
            sb.append("['lib/release/gt.ae64P', {target: 'ti.targets.elf.C64P', suffix: 'e64P'}],\n");
            sb.append("['lib/debug/gt.ae64T', {target: 'ti.targets.elf.C64T', suffix: 'e64T'}],\n");
            sb.append("['lib/release/gt.ae64T', {target: 'ti.targets.elf.C64T', suffix: 'e64T'}],\n");
            sb.append("['lib/debug/gt.ae674', {target: 'ti.targets.elf.C674', suffix: 'e674'}],\n");
            sb.append("['lib/release/gt.ae674', {target: 'ti.targets.elf.C674', suffix: 'e674'}],\n");
            sb.append("['lib/debug/gt.aearp32', {target: 'ti.targets.elf.arp32.ARP32', suffix: 'earp32'}],\n");
            sb.append("['lib/release/gt.aearp32', {target: 'ti.targets.elf.arp32.ARP32', suffix: 'earp32'}],\n");
            sb.append("['lib/debug/gt.a86U', {target: 'gnu.targets.Linux86', suffix: '86U'}],\n");
            sb.append("['lib/release/gt.a86U', {target: 'gnu.targets.Linux86', suffix: '86U'}],\n");
            sb.append("['lib/debug/gt.av5T', {target: 'gnu.targets.arm.GCArmv5T', suffix: 'v5T'}],\n");
            sb.append("['lib/release/gt.av5T', {target: 'gnu.targets.arm.GCArmv5T', suffix: 'v5T'}],\n");
            sb.append("['lib/debug/gt.abnc', {target: 'google.targets.arm.Bionic', suffix: 'bnc'}],\n");
            sb.append("['lib/release/gt.abnc', {target: 'google.targets.arm.Bionic', suffix: 'bnc'}],\n");
            sb.append("['lib/debug/gt.a470uC', {target: 'gnu.targets.arm.UCArm9', suffix: '470uC'}],\n");
            sb.append("['lib/release/gt.a470uC', {target: 'gnu.targets.arm.UCArm9', suffix: '470uC'}],\n");
            sb.append("['lib/debug/gt.aem3', {target: 'ti.targets.arm.elf.M3', suffix: 'em3'}],\n");
            sb.append("['lib/release/gt.aem3', {target: 'ti.targets.arm.elf.M3', suffix: 'em3'}],\n");
            sb.append("['lib/debug/gt.aea8f', {target: 'ti.targets.arm.elf.A8F', suffix: 'ea8f'}],\n");
            sb.append("['lib/release/gt.aea8f', {target: 'ti.targets.arm.elf.A8F', suffix: 'ea8f'}],\n");
        sb.append("];\n");
