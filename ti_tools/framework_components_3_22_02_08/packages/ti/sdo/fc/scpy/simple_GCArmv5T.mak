...
# Generated by build.filter.Make on Sun Apr 15 2012 23:10:50 GMT-0700 (PDT)
#
...
all: .objs/scpy_scpy.ov5T
clean::
	-$(RM) .objs/scpy_scpy.ov5T

$(LIBDIR)/scpy.av5T: .objs/scpy_scpy.ov5T 
	 $(CGTOOLS_V5T)/$(AR_V5T) cr $@ $^
all: $(LIBDIR)/scpy.av5T
clean::
	-$(RM) $(LIBDIR)/scpy.av5T
#
