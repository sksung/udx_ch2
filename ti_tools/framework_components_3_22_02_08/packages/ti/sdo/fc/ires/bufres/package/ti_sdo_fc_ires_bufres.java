...
public class ti_sdo_fc_ires_bufres
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            ...
            sb.append("'lib/debug/bufres.aearp32',\n");
            sb.append("'lib/release/bufres.aearp32',\n");
            ...
            sb.append("'lib/debug/bufres.abnc',\n");
            sb.append("'lib/release/bufres.abnc',\n");
            ...
            sb.append("'lib/debug/bufres.aea8f',\n");
            sb.append("'lib/release/bufres.aea8f',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            ...
            sb.append("['lib/debug/bufres.aearp32', {target: 'ti.targets.elf.arp32.ARP32', suffix: 'earp32'}],\n");
            sb.append("['lib/release/bufres.aearp32', {target: 'ti.targets.elf.arp32.ARP32', suffix: 'earp32'}],\n");
            sb.append("['lib/debug/bufres.a86U', {target: 'gnu.targets.Linux86', suffix: '86U'}],\n");
            sb.append("['lib/release/bufres.a86U', {target: 'gnu.targets.Linux86', suffix: '86U'}],\n");
            sb.append("['lib/debug/bufres.av5T', {target: 'gnu.targets.arm.GCArmv5T', suffix: 'v5T'}],\n");
            sb.append("['lib/release/bufres.av5T', {target: 'gnu.targets.arm.GCArmv5T', suffix: 'v5T'}],\n");
            sb.append("['lib/debug/bufres.abnc', {target: 'google.targets.arm.Bionic', suffix: 'bnc'}],\n");
            sb.append("['lib/release/bufres.abnc', {target: 'google.targets.arm.Bionic', suffix: 'bnc'}],\n");
            sb.append("['lib/debug/bufres.a470uC', {target: 'gnu.targets.arm.UCArm9', suffix: '470uC'}],\n");
            sb.append("['lib/release/bufres.a470uC', {target: 'gnu.targets.arm.UCArm9', suffix: '470uC'}],\n");
            ...
            sb.append("['lib/debug/bufres.aea8f', {target: 'ti.targets.arm.elf.A8F', suffix: 'ea8f'}],\n");
            sb.append("['lib/release/bufres.aea8f', {target: 'ti.targets.arm.elf.A8F', suffix: 'ea8f'}],\n");
        sb.append("];\n");
