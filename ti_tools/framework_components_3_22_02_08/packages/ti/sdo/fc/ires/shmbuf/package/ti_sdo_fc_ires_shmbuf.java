...
public class ti_sdo_fc_ires_shmbuf
{
    ...
    void SHMBUF$$TYPES()
    {
        ...
        po.addFld("isShared", $$T_Bool, true, "wh");
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            ...
            sb.append("'lib/debug/shmbuf.abnc',\n");
            sb.append("'lib/release/shmbuf.abnc',\n");
            sb.append("'lib/debug/shmbuf.a470uC',\n");
            sb.append("'lib/release/shmbuf.a470uC',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/shmbuf.a86U', {target: 'gnu.targets.Linux86', suffix: '86U'}],\n");
            sb.append("['lib/release/shmbuf.a86U', {target: 'gnu.targets.Linux86', suffix: '86U'}],\n");
            sb.append("['lib/debug/shmbuf.av5T', {target: 'gnu.targets.arm.GCArmv5T', suffix: 'v5T'}],\n");
            sb.append("['lib/release/shmbuf.av5T', {target: 'gnu.targets.arm.GCArmv5T', suffix: 'v5T'}],\n");
            sb.append("['lib/debug/shmbuf.abnc', {target: 'google.targets.arm.Bionic', suffix: 'bnc'}],\n");
            sb.append("['lib/release/shmbuf.abnc', {target: 'google.targets.arm.Bionic', suffix: 'bnc'}],\n");
            sb.append("['lib/debug/shmbuf.a470uC', {target: 'gnu.targets.arm.UCArm9', suffix: '470uC'}],\n");
            sb.append("['lib/release/shmbuf.a470uC', {target: 'gnu.targets.arm.UCArm9', suffix: '470uC'}],\n");
        sb.append("];\n");
