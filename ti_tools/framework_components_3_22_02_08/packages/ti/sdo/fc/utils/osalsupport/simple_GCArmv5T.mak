...
.objs/osal_support_OsalSupport.ov5T: OsalSupport.c
...
all: .objs/osal_support_OsalSupport.ov5T
clean::
	-$(RM) .objs/osal_support_OsalSupport.ov5T

$(LIBDIR)/osal_support.av5T: .objs/osal_support_OsalSupport.ov5T 
	 $(CGTOOLS_V5T)/$(AR_V5T) cr $@ $^
all: $(LIBDIR)/osal_support.av5T
clean::
	-$(RM) $(LIBDIR)/osal_support.av5T
#
