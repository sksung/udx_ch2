...
# Generated by build.filter.Make on Sun Apr 15 2012 23:10:59 GMT-0700 (PDT)
#
...
.objs/gt_noOS_GT_config_noOS.ov5T: GT_config_noOS.c
...
all: .objs/gt_noOS_GT_config_noOS.ov5T
clean::
	-$(RM) .objs/gt_noOS_GT_config_noOS.ov5T

.objs/gt_noOS_Trace.ov5T: Trace.c
	 $(CGTOOLS_V5T)/$(CC_V5T) -c -MD -MF $@.dep -x c  -fPIC -Wunused -Wall -fno-strict-aliasing  -march=armv5t -Dfar=   -DDBC_ASSERTS=0 -Dxdc_runtime_Assert_DISABLE_ALL=1  -Dxdc_target_name__=GCArmv5T -Dxdc_target_types__=gnu/targets/arm/std.h -Dxdc_bld__profile_release -Dxdc_bld__vers_1_0_4_2_0 -O2 -ffunction-sections  $(INCS)  -o $@ $<
	 
all: .objs/gt_noOS_Trace.ov5T
clean::
	-$(RM) .objs/gt_noOS_Trace.ov5T

$(LIBDIR)/gt_noOS.av5T: .objs/gt_noOS_GT_config_noOS.ov5T .objs/gt_noOS_Trace.ov5T 
	 $(CGTOOLS_V5T)/$(AR_V5T) cr $@ $^
all: $(LIBDIR)/gt_noOS.av5T
clean::
	-$(RM) $(LIBDIR)/gt_noOS.av5T
#
