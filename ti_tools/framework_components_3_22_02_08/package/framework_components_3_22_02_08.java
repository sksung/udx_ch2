...
public class framework_components_3_22_02_08
{
    ...
    void $$OBJECTS()
    {
        pkgP = (Proto.Obj)om.bind("framework_components_3_22_02_08.Package", new Proto.Obj());
        pkgV = (Value.Obj)om.bind("framework_components_3_22_02_08", new Value.Obj("framework_components_3_22_02_08", pkgP));
    }

    void $$SINGLETONS()
    {
        pkgP.init("framework_components_3_22_02_08.Package", (Proto.Obj)om.findStrict("xdc.IPackage.Module", "framework_components_3_22_02_08"));
        pkgP.bind("$capsule", $$UNDEF);
        pkgV.init2(pkgP, "framework_components_3_22_02_08", Value.DEFAULT, false);
        pkgV.bind("$name", "framework_components_3_22_02_08");
        pkgV.bind("$category", "Package");
        pkgV.bind("$$qn", "framework_components_3_22_02_08.");
        ...
        sb.append("var pkg = xdc.om['framework_components_3_22_02_08'];\n");
    ...
    void $$INITIALIZATION()
    {
        ...
        ((Value.Arr)om.findStrict("$packages", "framework_components_3_22_02_08")).add(pkgV);
    }
