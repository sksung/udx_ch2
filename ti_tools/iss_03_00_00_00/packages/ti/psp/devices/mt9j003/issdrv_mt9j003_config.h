...
UInt32 SensorConfigScript30fps[65][3] = {
    {0x0100, 2, 0x00},
    {100, 0, 100},
    {0x0300, 2, 0x3},
    {0x0302, 2, 0x1},
...
UInt32 SensorConfigScript[65][3] = {
    {0x0100, 2, 0x00},
    {100, 0, 100},
    {0x0300, 2, 0x3},
    {0x0302, 2, 0x1},
...
UInt32 SensorConfigScript5MP[65][3] = {
    {0x0100, 2, 0x00},
    {100, 0, 100},
    {0x0300, 2, 0x3},
    {0x0302, 2, 0x1},
...
UInt32 SensorConfigScript8MP[65][3] = {
    {0x0100, 2, 0x00},
    {100, 0, 100},
    {0x0300, 2, 0x3},
    {0x0302, 2, 0x1},
...
UInt32 SensorConfigScript10MP[65][3] = {
	/* Disable Streaming */
    {0x0100, 2, 0x00},
    {100, 0, 100},
    /* PLL */
