...
extern csi2_regs_ovly csi2B_regs;
                                  ...
                                  CSI2_GLOBAL_INTERRUPT_ID_T int_id)
{
    ...
    csi2_regs = (dev_num == CSI2_DEVICE_A) ? (csi2A_regs) : (csi2B_regs);
                                              ...
                                              CSI2_CTX_INTERRUPT_ID_T int_id)
{
    ...
    base_add =
        (uint32) ((dev_num == CSI2_DEVICE_A) ? (csi2A_regs) : (csi2B_regs));
...
csi2_complex_io_irq_init()
{
    ...
    for (i = CSI2_DEVICE_A; i < CSI2_DEVICE_MAX; i++)
    {
        ...
        csi2_register_interrupt_handler(i, CSI2_COMPLEXIO1_ERR_IRQ,
                                        ...
                                        i, (void *) CSI2_IO_1);
        // csi2A_regs and csi2B_regs are not initialized
