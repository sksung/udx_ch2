...
typedef struct {
    ...
    UInt8
        *writeDescAddr[ISS_CAPT_VCH_PER_LCH_MAX]
        [ISS_CAPT_NUM_WRITE_DATA_DESC_SET];
    UInt32 writeDescIdx[ISS_CAPT_VCH_PER_LCH_MAX];
...
#ifdef ISS_CPAT_ERR_TIME_TRACK_ENABLE
    Iss_CaptStatsTimeObj errTimeStamps[ISS_CAPT_ERR_TIME_TRACK_SIZE];
    UInt32 errTimeStampIndex;
#endif                                                     /** ISS_CPAT_ERR_TIME_TRACK_ENABLE
                                                            */

#ifdef ISS_CPAT_FID_RPT_TIME_TRACK_ENABLE
    Iss_CaptFidRptObj fidRptTimeStamps[ISS_CAPT_FID_RPT_TIME_TRACK_SIZE];
    UInt32 fidRptIndex;
#endif                                                     /** ISS_CPAT_FID_RPT_TIME_TRACK_ENABLE
                                                            */

    FVID2_Frame dropFrame[ISS_CAPT_NUM_WRITE_DATA_DESC_SET];
