...
const int16 gamma_iss_ud_table[] = {
	#include "../inc/tables/ud_test_gamma_table.h"
};
const ipipe_gamma_cfg_t gamma_iss_default_params = {
    ...
    IPIPE_GAMMA_BYPASS_DISABLE,                            // IPIPE_GAMMA_BYPASS_T
                                                           // bypass_r;
    (int16 *) gamma_iss_ud_table,                     // uint32 *
                                                           // red_table;
    (int16 *) gamma_iss_ud_table,                     // uint32 *
                                                           // blue_table;
    (int16 *) gamma_iss_ud_table					    // uint32*
...
const uint16 rgb_rgb1_iss_default_gainparams[9] = {256, 0, 0, 0, 256, 0, 0, 0, 256};
...
IssIpipeFillDefaultParams(iss_config_processing_t * iss_config)
{
    ...
    /* Use Edge Enhancement, 2012-05-13, Hennessy */
  #if 0
    iss_config->ee          = (ipipe_ee_cfg_t*            )&edge_enhance_default_cap_params_no_ee;
  #else
    iss_config->ee          = (ipipe_ee_cfg_t*            )&edge_enhance_iss_default_params;
  #endif
...
IssIsifFillDefaultParams(iss_config_processing_t * iss_config)
{
	...
	iss_config->clamp->dcoffset_clamp_value = (uint16)-0x29;//-0x39; //kjs
#else
