...
#
# ISS Drivers
iss_ud2a_RELPATH = ti/psp/iss/alg/aewb/ud2a
iss_ud2a_PATH = $(iss_PATH)/packages/$(iss_alg_RELPATH)
iss_ud2a_INCLUDE = $(iss_PATH)/packages
iss_ud2a_PKG_LIST = iss_ud2a
iss_ud2a_PLATFORM_DEPENDENCY = yes
