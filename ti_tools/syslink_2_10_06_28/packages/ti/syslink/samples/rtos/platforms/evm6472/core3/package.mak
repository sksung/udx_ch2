...
override PKGDIR = ti/syslink/samples/rtos/platforms/evm6472/core3
...
package/%.xdc.inc package/%_ti.syslink.samples.rtos.platforms.evm6472.core3.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.syslink.samples.rtos.platforms.evm6472.core3" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.syslink.samples.rtos.platforms.evm6472.core3 $@
...
.PHONY: release,ti_syslink_samples_rtos_platforms_evm6472_core3
ti_syslink_samples_rtos_platforms_evm6472_core3.zip: package/package.bld.xml
ti_syslink_samples_rtos_platforms_evm6472_core3.zip: package/package.ext.xml
ti_syslink_samples_rtos_platforms_evm6472_core3.zip: package/package.rel.dot
ti_syslink_samples_rtos_platforms_evm6472_core3.zip: package/build.cfg
ti_syslink_samples_rtos_platforms_evm6472_core3.zip: package/package.xdc.inc
ti_syslink_samples_rtos_platforms_evm6472_core3.zip: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_syslink_samples_rtos_platforms_evm6472_core3.zip.dep
endif
package/rel/ti_syslink_samples_rtos_platforms_evm6472_core3/ti/syslink/samples/rtos/platforms/evm6472/core3/package/package.rel.xml:

ti_syslink_samples_rtos_platforms_evm6472_core3.zip: package/rel/ti_syslink_samples_rtos_platforms_evm6472_core3.xdc.inc package/rel/ti_syslink_samples_rtos_platforms_evm6472_core3/ti/syslink/samples/rtos/platforms/evm6472/core3/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELZIP,package/rel/ti_syslink_samples_rtos_platforms_evm6472_core3.xdc.inc,package/rel/ti_syslink_samples_rtos_platforms_evm6472_core3.zip.dep)


release release,ti_syslink_samples_rtos_platforms_evm6472_core3: all ti_syslink_samples_rtos_platforms_evm6472_core3.zip
clean:: .clean
	-$(RM) ti_syslink_samples_rtos_platforms_evm6472_core3.zip
	-$(RM) package/rel/ti_syslink_samples_rtos_platforms_evm6472_core3.xdc.inc
	-$(RM) package/rel/ti_syslink_samples_rtos_platforms_evm6472_core3.zip.dep
