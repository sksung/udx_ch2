...
REM Size of RAM disk (needs to be larger than total slave executables)
SET size=25165824

SET ramfilename=%APP_DIR%\RingIORamDisk
SET sourcefilename=%APP_DIR%\RingIORamDisk.c
SET arraysymbolname=RamDiskArray

SET dspfilename=%APP_DIR%\slaveBuild\ti_syslink_samples_rtos_platforms_ti814x_dsp\debug\ringio_ti814x_dsp.xe674
SET videofilename=%APP_DIR%\slaveBuild\ti_syslink_samples_rtos_platforms_ti814x_videom3\debug\ringio_ti814x_videom3.xem3
SET vpssfilename=%APP_DIR%\slaveBuild\ti_syslink_samples_rtos_platforms_ti814x_vpssm3\debug\ringio_ti814x_vpssm3.xem3
