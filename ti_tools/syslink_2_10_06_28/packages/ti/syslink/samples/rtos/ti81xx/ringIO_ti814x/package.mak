...
override PKGDIR = ti/syslink/samples/rtos/ti81xx/ringIO_ti814x
...
package/%.xdc.inc package/%_ti.syslink.samples.rtos.ti81xx.ringIO_ti814x.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.syslink.samples.rtos.ti81xx.ringIO_ti814x" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.syslink.samples.rtos.ti81xx.ringIO_ti814x $@
...
.PHONY: release,ti.syslink.samples.rtos.ti81xx.ringIO_ti814x,src
ti.syslink.samples.rtos.ti81xx.ringIO_ti814x,src.tar: package/package.bld.xml
ti.syslink.samples.rtos.ti81xx.ringIO_ti814x,src.tar: package/package.ext.xml
ti.syslink.samples.rtos.ti81xx.ringIO_ti814x,src.tar: package/package.rel.dot
ti.syslink.samples.rtos.ti81xx.ringIO_ti814x,src.tar: package/build.cfg
ti.syslink.samples.rtos.ti81xx.ringIO_ti814x,src.tar: package/package.xdc.inc
ti.syslink.samples.rtos.ti81xx.ringIO_ti814x,src.tar: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti.syslink.samples.rtos.ti81xx.ringIO_ti814x,src.tar.dep
endif
package/rel/ti.syslink.samples.rtos.ti81xx.ringIO_ti814x,src/ti/syslink/samples/rtos/ti81xx/ringIO_ti814x/package/package.rel.xml:

ti.syslink.samples.rtos.ti81xx.ringIO_ti814x,src.tar: package/rel/ti.syslink.samples.rtos.ti81xx.ringIO_ti814x,src.xdc.inc package/rel/ti.syslink.samples.rtos.ti81xx.ringIO_ti814x,src/ti/syslink/samples/rtos/ti81xx/ringIO_ti814x/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti.syslink.samples.rtos.ti81xx.ringIO_ti814x$(comma)src.xdc.inc,package/rel/ti.syslink.samples.rtos.ti81xx.ringIO_ti814x$(comma)src.tar.dep)


release release,ti.syslink.samples.rtos.ti81xx.ringIO_ti814x,src: all ti.syslink.samples.rtos.ti81xx.ringIO_ti814x,src.tar
clean:: .clean
	-$(RM) ti.syslink.samples.rtos.ti81xx.ringIO_ti814x,src.tar
	-$(RM) package/rel/ti.syslink.samples.rtos.ti81xx.ringIO_ti814x,src.xdc.inc
	-$(RM) package/rel/ti.syslink.samples.rtos.ti81xx.ringIO_ti814x,src.tar.dep


.PHONY: release,ti_syslink_samples_rtos_ti81xx_ringIO_ti814x
ti_syslink_samples_rtos_ti81xx_ringIO_ti814x.tar: package/package.bld.xml
ti_syslink_samples_rtos_ti81xx_ringIO_ti814x.tar: package/package.ext.xml
ti_syslink_samples_rtos_ti81xx_ringIO_ti814x.tar: package/package.rel.dot
ti_syslink_samples_rtos_ti81xx_ringIO_ti814x.tar: package/build.cfg
ti_syslink_samples_rtos_ti81xx_ringIO_ti814x.tar: package/package.xdc.inc
ti_syslink_samples_rtos_ti81xx_ringIO_ti814x.tar: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_syslink_samples_rtos_ti81xx_ringIO_ti814x.tar.dep
endif
package/rel/ti_syslink_samples_rtos_ti81xx_ringIO_ti814x/ti/syslink/samples/rtos/ti81xx/ringIO_ti814x/package/package.rel.xml:

ti_syslink_samples_rtos_ti81xx_ringIO_ti814x.tar: package/rel/ti_syslink_samples_rtos_ti81xx_ringIO_ti814x.xdc.inc package/rel/ti_syslink_samples_rtos_ti81xx_ringIO_ti814x/ti/syslink/samples/rtos/ti81xx/ringIO_ti814x/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_syslink_samples_rtos_ti81xx_ringIO_ti814x.xdc.inc,package/rel/ti_syslink_samples_rtos_ti81xx_ringIO_ti814x.tar.dep)


release release,ti_syslink_samples_rtos_ti81xx_ringIO_ti814x: all ti_syslink_samples_rtos_ti81xx_ringIO_ti814x.tar
clean:: .clean
	-$(RM) ti_syslink_samples_rtos_ti81xx_ringIO_ti814x.tar
	-$(RM) package/rel/ti_syslink_samples_rtos_ti81xx_ringIO_ti814x.xdc.inc
	-$(RM) package/rel/ti_syslink_samples_rtos_ti81xx_ringIO_ti814x.tar.dep
