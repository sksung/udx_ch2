...
#define FVID2_VPS_VID_DEC_MT9D111_DRV    (VPS_VID_DEC_DRV_BASE + 0x0003u)

/** \brief THCV218 SERDES driver ID used at the time of FVID2_create() */
#define FVID2_VPS_VID_DEC_THCV218_DRV    (VPS_VID_DEC_DRV_BASE + 0x0004u)

/** \brief PH1100K sensor driver ID used at the time of FVID2_create() */
#define FVID2_VPS_VID_DEC_PH1100K_DRV    (VPS_VID_DEC_DRV_BASE + 0x0005u)
#define FVID2_VPS_VID_DEC_PH3100K_DRV    (VPS_VID_DEC_DRV_BASE + 0x0006u)
...
Int32 Vps_deviceRead16 (UInt8 instId, UInt8 devAddr,
					const UInt8 *regAddr, UInt16 *regValue, UInt32 numRegs);
Int32 Vps_deviceWrite16 (UInt8 instId, UInt8 devAddr,
					const UInt8 *regAddr, UInt16 *regValue, UInt32 numRegs);
