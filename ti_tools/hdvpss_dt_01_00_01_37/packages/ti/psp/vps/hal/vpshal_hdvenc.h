...
typedef struct
{
    ...
    UInt8                                   hsShift;
    /**< Delay the horizontal sync by specific number of clock cycles.
         Maximum delay is 6.5 Cycles, with resolution of 0.5 clock
        cycles */
    UInt8                                   vsShift;
    /**< Delay the vertical sync by specific number of clock cycles.
         Maximum delay is 6.5 Cycles, with resolution of 0.5 clock
        cycles */
    UInt8                                   fidShift;
    /**< Delay the FID by specific number of clock cycles.
         Maximum delay is 6.5 Cycles, with resolution of 0.5 clock
        cycles */
