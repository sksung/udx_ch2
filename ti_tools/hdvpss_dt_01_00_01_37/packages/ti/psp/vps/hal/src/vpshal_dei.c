                          ...
                          Ptr configOvlyPtr)
{
    ...
    else /* Progressive mode */
    {
        ...
        height = config->height;
        /* For TI816x PG2.0, use interlace bypass mode in case of progressive
         * input as progressive mode has 1/3rd performance drop.
         * And progressive bypass mode is not supported in TI814x family DEI,
         * so make it interlaced bypass */
        ...
        {
            /* For progressive inputs, irrespective of the bypass flag DEI
             * should be set in bypass mode only */
            interlaceBypass = FALSE;
