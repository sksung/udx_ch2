...
#define VPSMDRV_DEIH_MAX_FIELD_CONTEXT  (3u)
...
typedef struct
{
    ...
    /**< Time To Hold - The current field would be used as context field for
         next VPSMDRV_DEI_MAX_FIELD_CONTEXT/VPSMDRV_DEIH_MAX_FIELD_CONTEXT
         input fields.
         Will be initialized with
         VPSMDRV_DEI_MAX_FIELD_CONTEXT/VPSMDRV_DEIH_MAX_FIELD_CONTEXT when
...
typedef struct
{
    ...
    VpsMdrv_DeiCtxBufObj            ctxFieldFifo
                                        [VPSMDRV_DEIH_MAX_FIELD_CONTEXT + 1u];
