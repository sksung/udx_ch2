...
/* Set the PLLs */
#define CONFIG_PLL
#define HDVPSS_CLOCK	400		//# ucx: 100M
...
#define VPS_TI8107_GPIO0_BASE           (0x48032000u)
#define VPS_TI8107_GPIO1_BASE           (0x4804C000u)
#define VPS_TI8107_GPIO2_BASE           (0x481AC000u)
#define VPS_TI8107_GPIO3_BASE           (0x481AE000u)
...
#define VPS_TI8107_GPIO0_OE             (VPS_TI8107_GPIO0_BASE + 0x134)
...
#define VPS_TI8107_GPIO3_OE             (VPS_TI8107_GPIO3_BASE + 0x134)
...
Int32 Vps_platformTI8107DeviceInit(Vps_PlatformDeviceInitParams *initPrms)
{
	...
	deviceInitPrm.i2cRegs[VPS_PLATFORM_EVM_I2C_INST_ID] = (Ptr)CSL_TI8107_I2C2_BASE;
	deviceInitPrm.i2cIntNum[VPS_PLATFORM_EVM_I2C_INST_ID] = CSL_INTC_EVENTID_I2CINT2;
	deviceInitPrm.i2cClkKHz[VPS_PLATFORM_EVM_I2C_INST_ID] = 320;

    status = Vps_deviceInit ( &deviceInitPrm );

#ifdef ENABLE_I2C_PROBE_ON_INIT
    if (TRUE == initPrms->isI2cInitReq && TRUE == initPrms->isI2cProbingReq) {
...
{
    UInt8 devAddr;
    UInt8 devAddrTvp5158[VPS_CAPT_INST_MAX] = { 0x00, 0x00, 0x5c, 0x5f };
    UInt8 devAddrPh1100k[VPS_CAPT_INST_MAX] = { 0x32, 0x00, 0x00, 0x00 };
    ...
    switch (vidDecId)
    {
        ...
        case FVID2_VPS_VID_DEC_PH1100K_DRV:
        case FVID2_VPS_VID_DEC_PH3100K_DRV:
        case FVID2_VPS_VID_DEC_MT9D111_DRV:
            devAddr = devAddrPh1100k[vipInstId];
            break;
...
static Int32 Vps_platformTI8107ConfigHdVpssPll(void)
{
    ...
    /* set HDVPSS Clock */
    Vps_platformPllCfg(baseAddr, 19, HDVPSS_CLOCK, 4, ADPLLJ_CLKCRTL_HS2);
...
{
	//# vin0 A
	REG32(CSL_TI8107_CTRL_MODULE_BASE + 0x0A20) = 0x50001;   /* vin0a_clk */
	REG32(CSL_TI8107_CTRL_MODULE_BASE + 0x0A2C) = 0x50001;   /* vin0_d[0] */
	REG32(CSL_TI8107_CTRL_MODULE_BASE + 0x0A30) = 0x50001;   /* vin0_d[1] */
	REG32(CSL_TI8107_CTRL_MODULE_BASE + 0x0A34) = 0x50001;   /* vin0_d[2] */
	REG32(CSL_TI8107_CTRL_MODULE_BASE + 0x0A38) = 0x50001;   /* vin0_d[3] */
	REG32(CSL_TI8107_CTRL_MODULE_BASE + 0x0A3c) = 0x50001;   /* vin0_d[4] */
	REG32(CSL_TI8107_CTRL_MODULE_BASE + 0x0A40) = 0x50001;   /* vin0_d[5] */
	REG32(CSL_TI8107_CTRL_MODULE_BASE + 0x0A44) = 0x50001;   /* vin0_d[6] */
	REG32(CSL_TI8107_CTRL_MODULE_BASE + 0x0A48) = 0x50001;   /* vin0_d[7] */

	//# vin0 B
	REG32(CSL_TI8107_CTRL_MODULE_BASE + 0x0A14) = 0x50001;   /* vin0b_clk */
	REG32(CSL_TI8107_CTRL_MODULE_BASE + 0x0A4C) = 0x50001;   /* vin0b_d[0] */
	REG32(CSL_TI8107_CTRL_MODULE_BASE + 0x0A50) = 0x50001;   /* vin0b_d[1] */
	REG32(CSL_TI8107_CTRL_MODULE_BASE + 0x0A54) = 0x50001;   /* vin0b_d[2] */
	REG32(CSL_TI8107_CTRL_MODULE_BASE + 0x0A58) = 0x50001;   /* vin0b_d[3] */
	REG32(CSL_TI8107_CTRL_MODULE_BASE + 0x0A5C) = 0x50001;   /* vin0b_d[4] */
	REG32(CSL_TI8107_CTRL_MODULE_BASE + 0x0A60) = 0x50001;   /* vin0b_d[5] */
	REG32(CSL_TI8107_CTRL_MODULE_BASE + 0x0A64) = 0x50001;   /* vin0b_d[6] */
	REG32(CSL_TI8107_CTRL_MODULE_BASE + 0x0A68) = 0x50001;   /* vin0b_d[7] */
...
Int32 Vps_platformTI8107ResetVideoDevices(void)
{
    ...
    if (boardId == VPS_PLATFORM_BOARD_UBX)
    {
	    return FVID2_SOK;
    }
...
static Int32 Vps_platformTI8107EnableI2c(void)
{
    ...
    if (((gVpsPrcmRegs->CM_ALWON_I2C_13_CLKCTRL &
            ...
            CM_ALWON_I2C_13_CLKCTRL_IDLEST_SHIFT) != 0u)
    {
	    Vps_printf(" I2C1/3 Clk is Non active\n");
        return (FVID2_ETIMEOUT);
    }
    else
    {
	    Vps_printf(" I2C1/3 Clk is active\n");
    }
	#endif
                ...
                UInt32 N, UInt32 M, UInt32 M2, UInt32 CLKCTRL_VAL)
{
    ...
    //Vps_printf("----- %s: N %d, M %d, M2 %d, CLKCTRL_VAL 0x%x\n", __func__, N, M, M2, CLKCTRL_VAL);
