...
CC = $(CODEGEN_PATH_A8)/bin/cl470 
AR = $(CODEGEN_PATH_A8)/bin/ar470
LNK = $(CODEGEN_PATH_A8)/bin/lnk470
...
RTSLIB_PATH = $(CODEGEN_PATH_A8)/lib/rtsv7A8_A_$(RTSLIB_ENDIAN)_n_$(RTSLIB_FORMAT).lib
...
CONFIGURO_CMD = $(xdc_PATH)/xs xdc.tools.configuro --generationOnly -o $(CONFIGURO_DIR) -t $(TARGET_XDC) -p $(PLATFORM_XDC) \
               -r whole_program -c $(CODEGEN_PATH_A8) -b $(CONFIG_BLD_XDC_$(ISA)) $(XDC_CFG_FILE_NAME)
