                       ...
                       )
{
  ...
  if(!nChannelState[chnlNum].dynamicParams.viddec3DynamicParams.decodeHeader)
  {
    ...
    else
    {
      ...
      /*--------------------------------------------------------------------*/
      BufferCount = 2;
      BufferCount <<= nChannelState[chnlNum].params.enableDualOutput;
                         ...
                         )
{
  ...
  if(metaDataEnable[chnlNum][APP_SEI_DATA])
  {
    free((void *)nChannelState[chnlNum].buffArray[0].buf[2 + 
                ...
                (nChannelState[chnlNum].params.enableDualOutput*2)]);
  }
...
XDAS_Int32 TestAppMetaDataBuf(XDM2_BufSize *bufSizes,XDAS_Int8  chnlNum)
{
  ...
  /* SEI Allocation                                                         */
  /*------------------------------------------------------------------------*/
  metaBufIdx = 2 + metaDataIndex[chnlNum][APP_SEI_DATA] + 
            (nChannelState[chnlNum].params.enableDualOutput*2);
  ...
  /* VUI Allocation                                                         */
  /*------------------------------------------------------------------------*/
  metaBufIdx = 2 + metaDataIndex[chnlNum][APP_VUI_DATA] + 
                (nChannelState[chnlNum].params.enableDualOutput*2);
  Size        = bufSizes[metaBufIdx].bytes;
  ...
  /*------------------------------------------------------------------------*/
  metaBufIdx  = 2 + metaDataIndex[chnlNum][APP_MB_INFO] + 
                (nChannelState[chnlNum].params.enableDualOutput*2);
  Size        = bufSizes[metaBufIdx].bytes;
