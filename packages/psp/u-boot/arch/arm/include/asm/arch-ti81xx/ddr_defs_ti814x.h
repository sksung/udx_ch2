...
#endif /* #if !defined(CONFIG_TI813X) && !defined(CONFIG_TI811X) && !defined(CONFIG_DM385) */
 ...
 * MT41K128M16 - 1.35V DDR3L
 * Backward compatible to CL=8,CWL=6(-187)
 * tCK=min(1.875)ns
 */
/* UDWorks ISPN DDR3 EMIF CFG Registers values 533MHz */
#	define DDR3_EMIF_READ_LATENCY		0x00170209	//RD_ODT=0x2, IDLE_ODT=0x0, Dynamic power_down enabled
...
/* UDWorks ISPN DDR3 EMIF CFG Registers values 400MHz */
...
#	define DDR3_EMIF_SDRAM_ZQCR			0x50074BE2
#endif /* #ifdef CONFIG_ISPN_DDR3_533 */

#else /* #ifdef COMMON_UD_FEATURE */
/* TI814X EVM DDR3 EMIF CFG Registers values 400MHz */
#	define DDR3_EMIF_READ_LATENCY		0x00170208	//RD_ODT=0x2, IDLE_ODT=0x0, Dynamic power_down enabled
