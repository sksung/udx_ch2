...
#ifdef CONFIG_TI81XX
	priv_data->base_addr = (struct hsmmc *)OMAP_HSMMC_BASE;

	#ifdef CONFIG_HSMMC2_8BIT
	/* Enable 8-bit interface for eMMC on OMAP4/5 or DRA7XX or TI814X */
...
#endif /* #if defined(CONFIG_TI81XX) */
