...
int _board_mmc_getwp(struct mmc *mmc)
{
	return -1;
}
int board_mmc_getwp(struct mmc *mmc)__attribute__((weak,
	alias("_board_mmc_getwp")));
...
int _board_mmc_getcd(struct mmc *mmc)
{
	return -1;
}
int board_mmc_getcd(struct mmc *mmc)__attribute__((weak,
	alias("_board_mmc_getcd")));
