...
static struct mmc *init_mmc_device(int dev, unsigned char force_init)
{
	struct mmc *mmc;
...
static int do_mmcinfo (cmd_tbl_t *cmdtp, int flag, int argc, char *argv[])
{
	struct mmc *mmc;
...
#endif /* #ifdef CONFIG_SUPPORT_EMMC_RPMB */
...
static cmd_tbl_t cmd_mmc[] = {
	U_BOOT_CMD_MKENT(info, 1, 0, (void *)do_mmcinfo, "", ""),
	U_BOOT_CMD_MKENT(read, 4, 1, (void *)do_mmc_read, "", ""),
	U_BOOT_CMD_MKENT(write, 4, 0, (void *)do_mmc_write, "", ""),
	U_BOOT_CMD_MKENT(erase, 3, 0, (void *)do_mmc_erase, "", ""),
	U_BOOT_CMD_MKENT(rescan, 1, 1, (void *)do_mmc_rescan, "", ""),
	U_BOOT_CMD_MKENT(part, 1, 1, (void *)do_mmc_part, "", ""),
	U_BOOT_CMD_MKENT(dev, 3, 0, (void *)do_mmc_dev, "", ""),
	U_BOOT_CMD_MKENT(list, 1, 1, (void *)do_mmc_list, "", ""),
#ifdef CONFIG_SUPPORT_EMMC_BOOT /* not supported */
	U_BOOT_CMD_MKENT(bootbus, 5, 0, do_mmc_bootbus, "", ""),
	U_BOOT_CMD_MKENT(bootpart-resize, 3, 0, do_mmc_boot_resize, "", ""),
	U_BOOT_CMD_MKENT(partconf, 5, 0, do_mmc_partconf, "", ""),
	U_BOOT_CMD_MKENT(rst-function, 3, 0, do_mmc_rst_func, "", ""),
#endif
#ifdef CONFIG_SUPPORT_EMMC_RPMB /* not supported */
