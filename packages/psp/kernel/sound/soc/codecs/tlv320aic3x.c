...
static const u8 aic3x_reg[AIC3X_CACHEREGNUM] = {
	...
	0x00, 0x00, 0x08, 0x80,	/* 12 */ /* pseudo diff */
	...
	0x00, 0x00, 0x00, 0x64,	/* 48 */ /* HPLOUT->6dB */
	0x00, 0x00, 0x00, 0x00,	/* 52 */
	0x00, 0x00, 0x64, 0x00,	/* 56 */ /* HPLCOM->6dB */
...
/* Line out gain volumes. From 0 to 9dB in 1.0 dB steps */
static DECLARE_TLV_DB_SCALE(line_out_tlv, 0, 100, 9);
#endif
...
#ifdef CONFIG_COMMON_UD_FEATURE
	SOC_DOUBLE_R_TLV("Line Playback Volume",
			 LLOPM_CTRL, RLOPM_CTRL, 4, 9, 0, line_out_tlv),
#endif
};
...
static int aic3x_init(struct snd_soc_codec *codec)
{
	...
	/* Headphone control */
	/* stereo pseudodifferential */
	//snd_soc_write(codec, AIC3X_HEADSET_DETECT_CTRL_B, 0x08);
	/* set to avoid artifacts on the audio output during power-on/off */
	snd_soc_write(codec, HPOUT_POP_REDUCTION, 0x5e); /* 50 + 4 ms, reference*/
