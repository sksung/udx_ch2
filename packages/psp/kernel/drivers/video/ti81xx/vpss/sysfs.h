...
static const struct dc_vencmode_info vmode_info[] = {
	...
	{"800x480@60", FVID2_STD_WVGA_60,
		...
		//30000, 60, 164, 89, 10, 10, 23, 10},
		28000, 60, 20, 20, 4, 16, 15, 10},
		#endif
	    TI81xx_MODE_DVI
	},
	/*WXGA*/
	...
	/*HVGA*/	//# phoong - for lcd
	{"480x320@60", FVID2_STD_HVGA_60,
	    {FVID2_STD_QVGA_60, 320, 480, FVID2_SF_PROGRESSIVE,
		12500, 60, 10, 8, 10, 4, 4, 10},
	    TI81xx_MODE_DVI
	},
	/*QVGA*/	//# phoong - for lcd (ver0.1)
	{"320x240@60", FVID2_STD_QVGA_60,
	    {FVID2_STD_QVGA_60, 240, 320, FVID2_SF_PROGRESSIVE,
		6000, 60, 8, 43, 41, 3, 12, 10},
	    TI81xx_MODE_DVI
	},
	/*480P*/
