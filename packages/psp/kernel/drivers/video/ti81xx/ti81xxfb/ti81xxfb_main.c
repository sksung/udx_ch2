...
static int ti81xxfb_allocate_fbs(struct ti81xxfb_device *fbdev)
{
	...
	if (def_vram && ti81xxfb_parse_vram_param(def_vram, TI81XX_FB_NUM,
		...
		vrams[0] =  0x20000;	//# reserved
		vrams[1] = 0x180000;	//# 1.5M (800x480x4, 0x177000)
		vrams[2] = 0x160000;	//# 1.4M (720x480x4, 0x151800)
	}
			...
			struct fb_info *fbi)
{
	...
	vpss_datamode_to_tfb_datamode(FVID2_DF_RGB16_565, var);
