...
#define TI81XX_CTRL_REGADDR(reg)					\
...
#define TI814X_CONTROL_PCIE_PLLCFG3	(TI81XX_CONTROL_DEVCONF + 0x0E4)
#define TI814X_CONTROL_PCIE_PLLCFG4	(TI81XX_CONTROL_DEVCONF + 0x0E8)
#define TI814X_CONTROL_PCIE_PLLSTATUS	(TI81XX_CONTROL_DEVCONF + 0x0EC)
#define TI814X_CONTROL_PCIE_MISCCFG	(TI81XX_CONTROL_DEVCONF + 0x0FC)
#define TI814X_SERDES_REFCLK_CTL	(TI81XX_CONTROL_DEVCONF + 0x824)
#define TI814X_CONTROL_PCIE_CFG		0x0480
#define TI814X_CONTROL_SMA0			0x1318
#define TI814X_REFCLK_LJCBLDO_CTRL  0x0440

#define TI814X_CONTROL_SATA_PLLCFG0	(TI81XX_CONTROL_DEVCONF + 0x120)
#define TI814X_CONTROL_SATA_PLLCFG1	(TI81XX_CONTROL_DEVCONF + 0x124)
#define TI814X_CONTROL_SATA_PLLCFG2	(TI81XX_CONTROL_DEVCONF + 0x128)
#define TI814X_CONTROL_SATA_PLLCFG3	(TI81XX_CONTROL_DEVCONF + 0x12C)
#define TI814X_CONTROL_SATA_PLLCFG4	(TI81XX_CONTROL_DEVCONF + 0x130)
#define TI814X_CONTROL_SATA_PLLSTATUS	(TI81XX_CONTROL_DEVCONF + 0x134)
#define TI814X_CONTROL_SATA_RXSTATUS	(TI81XX_CONTROL_DEVCONF + 0x138)
#define TI814X_CONTROL_SATA_TXSTATUS	(TI81XX_CONTROL_DEVCONF + 0x13c)
#define TI814X_CONTROL_SATA_TESTCFG	(TI81XX_CONTROL_DEVCONF + 0x140)

/* SATA1 definitions - applies for TI813X */
#define TI813X_CONTROL_SATA1_PLLCFG0	(TI81XX_CONTROL_DEVCONF + 0x14c)
#define TI813X_CONTROL_SATA1_PLLCFG1	(TI81XX_CONTROL_DEVCONF + 0x150)
#define TI813X_CONTROL_SATA1_PLLCFG2	(TI81XX_CONTROL_DEVCONF + 0x154)
#define TI813X_CONTROL_SATA1_PLLCFG3	(TI81XX_CONTROL_DEVCONF + 0x158)
#define TI813X_CONTROL_SATA1_PLLCFG4	(TI81XX_CONTROL_DEVCONF + 0x15c)
#define TI813X_CONTROL_SATA1_PLLSTATUS	(TI81XX_CONTROL_DEVCONF + 0x160)
#define TI813X_CONTROL_SATA1_RXSTATUS	(TI81XX_CONTROL_DEVCONF + 0x164)
#define TI813X_CONTROL_SATA1_TXSTATUS	(TI81XX_CONTROL_DEVCONF + 0x168)
#define TI814X_CONTROL_SATA1_TESTCFG	(TI81XX_CONTROL_DEVCONF + 0x16c)

/* TI816X PLL Control register offsets */
#define TI816X_MAINPLL_CTRL		TI81XX_CTRL_REGADDR(0x0400)
#define TI816X_MAINPLL_PWD		TI81XX_CTRL_REGADDR(0x0404)
#define TI816X_MAINPLL_FREQ1		TI81XX_CTRL_REGADDR(0x0408)
#define TI816X_MAINPLL_DIV1		TI81XX_CTRL_REGADDR(0x040C)
#define TI816X_MAINPLL_FREQ2		TI81XX_CTRL_REGADDR(0x0410)
#define TI816X_MAINPLL_DIV2		TI81XX_CTRL_REGADDR(0x0414)
#define TI816X_MAINPLL_FREQ3		TI81XX_CTRL_REGADDR(0x0418)
#define TI816X_MAINPLL_DIV3		TI81XX_CTRL_REGADDR(0x041C)
#define TI816X_MAINPLL_FREQ4		TI81XX_CTRL_REGADDR(0x0420)
#define TI816X_MAINPLL_DIV4		TI81XX_CTRL_REGADDR(0x0424)
#define TI816X_MAINPLL_FREQ5		TI81XX_CTRL_REGADDR(0x0428)
#define TI816X_MAINPLL_DIV5		TI81XX_CTRL_REGADDR(0x042C)
#define TI816X_MAINPLL_DIV6		TI81XX_CTRL_REGADDR(0x0434)
#define TI816X_MAINPLL_DIV7		TI81XX_CTRL_REGADDR(0x043C)

#define TI816X_DDRPLL_CTRL		TI81XX_CTRL_REGADDR(0x0440)
#define TI816X_DDRPLL_PWD		TI81XX_CTRL_REGADDR(0x0444)
#define TI816X_DDRPLL_DIV1		TI81XX_CTRL_REGADDR(0x044C)
#define TI816X_DDRPLL_FREQ2		TI81XX_CTRL_REGADDR(0x0450)
#define TI816X_DDRPLL_DIV2		TI81XX_CTRL_REGADDR(0x0454)
#define TI816X_DDRPLL_FREQ3		TI81XX_CTRL_REGADDR(0x0458)
#define TI816X_DDRPLL_DIV3		TI81XX_CTRL_REGADDR(0x045C)
#define TI816X_DDRPLL_FREQ4		TI81XX_CTRL_REGADDR(0x0460)
#define TI816X_DDRPLL_DIV4		TI81XX_CTRL_REGADDR(0x0464)
#define TI816X_DDRPLL_FREQ5		TI81XX_CTRL_REGADDR(0x0468)
#define TI816X_DDRPLL_DIV5		TI81XX_CTRL_REGADDR(0x046C)

#define TI816X_DDR_RCD			TI81XX_CTRL_REGADDR(0x070C)

#define TI816X_VIDEOPLL_CTRL		TI81XX_CTRL_REGADDR(0x0470)
#define TI816X_VIDEOPLL_PWD		TI81XX_CTRL_REGADDR(0x0474)
#define TI816X_VIDEOPLL_FREQ1		TI81XX_CTRL_REGADDR(0x0478)
#define TI816X_VIDEOPLL_DIV1		TI81XX_CTRL_REGADDR(0x047C)
#define TI816X_VIDEOPLL_FREQ2		TI81XX_CTRL_REGADDR(0x0480)
#define TI816X_VIDEOPLL_DIV2		TI81XX_CTRL_REGADDR(0x0484)
#define TI816X_VIDEOPLL_FREQ3		TI81XX_CTRL_REGADDR(0x0488)
#define TI816X_VIDEOPLL_DIV3		TI81XX_CTRL_REGADDR(0x048C)

#define TI816X_AUDIOPLL_CTRL		TI81XX_CTRL_REGADDR(0x04A0)
#define TI816X_AUDIOPLL_PWD		TI81XX_CTRL_REGADDR(0x04A4)
#define TI816X_AUDIOPLL_FREQ2		TI81XX_CTRL_REGADDR(0x04B0)
#define TI816X_AUDIOPLL_DIV2		TI81XX_CTRL_REGADDR(0x04B4)
#define TI816X_AUDIOPLL_FREQ3		TI81XX_CTRL_REGADDR(0x04B8)
#define TI816X_AUDIOPLL_DIV3		TI81XX_CTRL_REGADDR(0x04BC)
#define TI816X_AUDIOPLL_FREQ4		TI81XX_CTRL_REGADDR(0x04C0)
#define TI816X_AUDIOPLL_DIV4		TI81XX_CTRL_REGADDR(0x04C4)
#define TI816X_AUDIOPLL_FREQ5		TI81XX_CTRL_REGADDR(0x04C8)
#define TI816X_AUDIOPLL_DIV5		TI81XX_CTRL_REGADDR(0x04CC)
