...
/* MMCHS0 Clock(final) */
#if defined(CONFIG_COMMON_UD_FEATURE) && defined(CONFIG_MMC_USE_MMC0)
...
static struct omap_clk ti814x_clks[] = {
	...
	/* To remap mmc slot index */
	CLK("mmci-omap-hs.0",	"ick",				&mmchs2_ick,			CK_TI814X | CK_DM385 | CK_TI811X),
	CLK("mmci-omap-hs.1",	"ick",				&mmchs3_ick,			CK_TI814X | CK_DM385 | CK_TI811X),
#else
...
#ifdef CONFIG_COMMON_UD_FEATURE
	/* To remap mmc slot index */
	CLK("mmci-omap-hs.0",	"fck",				&mmchs2_fck,			CK_TI814X | CK_DM385 | CK_TI811X),
	CLK("mmci-omap-hs.1",	"fck",				&mmchs3_fck,			CK_TI814X | CK_DM385 | CK_TI811X),
#else
...
#ifdef CONFIG_COMMON_UD_FEATURE
	CLK("mmci-omap-hs.0",	"mmchs2_dbck",			&mmchs2_dbck,			CK_TI814X | CK_DM385 | CK_TI811X),
	CLK("mmci-omap-hs.1",	"mmchs3_dbck",			&mmchs3_dbck,			CK_TI814X | CK_DM385 | CK_TI811X),
#else
