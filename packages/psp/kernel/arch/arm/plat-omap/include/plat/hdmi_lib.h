...
struct hdmi_core_video_config_t {
	...
	u16  CoreSyncFormat;
	/* This is the polarity generted by HDMI, in case of discrete sync
	   output polarity generated by HDMI is same as received from Venc.
	   In case of embedded sync input, this is required to be generated
	   by HDMI based on mode set.
	 */
	int vsync_polarity;
	int hsync_polarity;
};
