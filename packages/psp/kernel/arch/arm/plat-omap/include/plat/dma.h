...
/* Due to DMA re-mux for MMC2 event (ti81xx specific) */
#define OMAP24XX_DMA_MMC2_TX		64	/* map_xbar_event_to_channel */
#define OMAP24XX_DMA_MMC2_RX		65	/* SD[2]_RX instead of McASP2_RX */	
#else
