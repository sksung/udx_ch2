...
typedef enum
{
    ...
    */
    ...
    /**< Get/Set the SCD algorithm operation mode for a channel
            ...
            Refer to AlgLink_ScdChFrameParams structure
    */
...
/**
    ...
    \param pBitsBufList [OUT]   List of Bistream Buffers returned by the SCD Link
...
/**
    \brief Sets Audio codec parametes from
*/
Int32 Vcap_setAudioModeParam(UInt32 samplingHz, UInt32 audioVolume);
...
*/
Int32 Vcap_setColor(Int32 chId, Int32 brightness, Int32 contrast, Int32 saturation);
