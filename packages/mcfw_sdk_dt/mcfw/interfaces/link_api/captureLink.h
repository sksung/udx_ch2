...
#define CAPTURE_LINK_NUM_BLIND_AREA_PER_CHNL    (4)
...
#define CAPTURE_LINK_CMD_HALT_EXECUTION          (0x1003)
#define CAPTURE_LINK_CMD_CONFIGURE_VIP_DECODERS  (0x1004)
#define CAPTURE_LINK_CMD_GET_VIDEO_STATUS        (0x1005)
#define CAPTURE_LINK_CMD_SET_AUDIO_CODEC_PARAMS  (0x1006)
#define CAPTURE_LINK_CMD_PRINT_BUFFER_STATISTICS (0x1007)
#define CAPTURE_LINK_CMD_SET_EXTRA_FRAMES_CH_ID  (0x1008)
#define CAPTURE_LINK_CMD_CHANGE_COLOR			 (0x1009)

#define CAPTURE_LINK_CMD_VIDEO_REG_WRITE		 (0x100A)
#define CAPTURE_LINK_CMD_VIDEO_REG_READ			 (0x100B)
#ifdef ENABLE_BLIND_AREA
#define CAPTURE_LINK_CMD_CONFIGURE_BLIND_AREA    (0x1010)
#endif //ENABLE_BLIND_AREA
...
typedef struct
{
    ...
    UInt32	captureMode;		//# sync mode/embedded
    UInt32	serdesEQ;			//# ph3100k equalizer level
    UInt32	serdesPE;			//# ph3100k preemphasis level 
...
typedef struct
{
    ...
    CaptureLink_BlindWin      win[CAPTURE_LINK_NUM_BLIND_AREA_PER_CHNL];
...
typedef struct
{
    ...
    */
#ifdef ENABLE_BLIND_AREA
    CaptureLink_BlindInfo blindInfo[CAPTURE_LINK_MAX_OUTPUT_PER_INST * CAPTURE_LINK_MAX_CH_PER_OUT_QUE];
#endif //ENABLE_BLIND_AREA
