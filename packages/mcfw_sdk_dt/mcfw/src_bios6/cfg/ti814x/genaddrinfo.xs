...
function GetEndAddrString(start_addr, size)
{
...
function GenAddrFile()
{
    ...
    var CMEM_ADDR_START_STR         = Value2HexString(CMEM_ADDR);
    var CMEM_ADDR_END_STR           = Value2HexString(GetEndAddrString(CMEM_ADDR, CMEM_SIZE));
    ...
    fd.writeLine("");
    fd.writeLine("# The start address of CMEM section");
    fd.writeLine(GetShellExportString("CMEM_ADDR_START", CMEM_ADDR_START_STR));
    fd.writeLine("");
    fd.writeLine("# The end address of CMEM section");
    fd.writeLine(GetShellExportString("CMEM_ADDR_END", CMEM_ADDR_END_STR));
    fd.writeLine("");
