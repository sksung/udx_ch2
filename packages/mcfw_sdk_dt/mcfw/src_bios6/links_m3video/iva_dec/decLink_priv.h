...
#define DEC_LINK_GROUP_SUBM_MAX_SIZE 12 
...
typedef struct DecLink_OutObj {
    ...
    FVID2_Frame outFrames[DEC_LINK_MAX_OUT_FRAMES];
    System_FrameInfo frameInfo[DEC_LINK_MAX_OUT_FRAMES];
    UInt32 outNumFrames[UTILS_BUF_MAX_ALLOC_POOLS];
    FVID2_Format outFormat[UTILS_BUF_MAX_ALLOC_POOLS];
    UInt32 ch2poolMap[DEC_LINK_MAX_CH];
    EncDec_ResolutionClass reslutionClass[UTILS_BUF_MAX_ALLOC_POOLS];
    UInt32 numChPerResolutionClass[UTILS_BUF_MAX_ALLOC_POOLS];
} DecLink_OutObj;
