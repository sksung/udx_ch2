...
#define SYSTEM_LINK_FRAMES_PER_CH   (6)//(4)     /* Set to 4 for TI814X and TI816x 256M builds */
#else
...
/*
    15 is highest priority,  1 is lowest priority
...
#define CAMERA_LINK_TSK_PRI              (13)//(12)
...
#define SWOSD_LINK_TSK_PRI               (10)
#define VNF_LINK_TSK_PRI				 (10)
#define GLBCE_LINK_TSK_PRI				 (13)
#define ISP_LINK_TSK_PRI				 (13)//(12)
#define VA_LINK_TSK_PRI					 (3)
#define VA_LINK_PROCESSTSK_PRI			 (2)
