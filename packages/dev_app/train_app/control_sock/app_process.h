...
#pragma pack(1)
typedef struct TAG_CONNECT_USER
{
...
#pragma pack(1)
typedef struct TAG_RECDURPARAM_RES
{
...
#pragma pack(1)
typedef struct TAG_RECDURCFG_REQ
{
        unsigned short dur ;
} RECDURCFG_REQ ;
#pragma pack()
...
#pragma pack(1)
typedef struct TAG_LOCATION_REQ
{
        unsigned short identifier ;
        unsigned short cmd ;
        unsigned short length ;
...
#pragma pack(1)
typedef struct TAG_LOCATION_RES
{
        unsigned short identifier ;
        unsigned short cmd ;
        unsigned short length ;
        unsigned short port ;
        char ipaddress[STRING_SIZE] ;
...
typedef struct TAG_QUALITYPARAMRES {
        ...
        unsigned short cmd ;
        unsigned short length ;
        unsigned short Rec_bitrate ;
        unsigned short Live_bitrate ;
        unsigned short Rec_framerate ;
        unsigned short Live_framerate ;
} QUALITYPARAMRES ;
#pragma pack()
...
#pragma pack(1)
typedef struct TAG_LOGLISTRES {
        unsigned short identifier ;
        unsigned short cmd ;
        unsigned short length ;
        unsigned short result ;
        unsigned short file_count ;
        char           file_name[STRING_SIZE * 3] ;
} LOGLISTRES ;
#pragma pack()


#pragma pack(1)
typedef struct TAG_LOGFILEREQ {
...
void recdurcfgreq(int, char*, int) ;
...
void sdstatusreq(int, char*, int) ;
void connect_info_req(int, char*, int) ;
void camstatusreq(int, char*, int) ;

void loglistreq(int, char*, int) ;
void logfilereq(int, char*, int) ;
...
void avistreamstop(int, char*, int) ;
