...
typedef enum {
	PREC_RUNTIME_0 = 0,		//# NOR  30MIN / EVT ALYWAYS
	PREC_RUNTIME_1,			//# NOR  60MIN / EVT  60MIN
	PREC_RUNTIME_2,			//# NOR 120MIN / EVT 180MIN
	PREC_RUNTIME_3,			//# NOR 440MIN / EVT 720MIN
	PREC_RUNTIME_MAX
}app_prec_runtime_e;
...
typedef struct {
	int rec_mode;	//# normal or event recording
	int run_time;	//# app_prec_nor_runtime_e or app_prec_evt_runtime_e 
