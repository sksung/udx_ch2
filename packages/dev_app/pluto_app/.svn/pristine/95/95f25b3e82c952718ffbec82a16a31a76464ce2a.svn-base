...
//#define TIME_DEBUG
//#define DEBUG_GSV
//#define NO_SHUTDOWN_FOR_CRITICAL


#define USE_HDD_REC		(1)
#define FILE_ENCODE		(0)	

#define TCX_SW_VER		"1.00.05"
...
typedef struct {
	...
	char hdd_mount_path[CHAR_128];	//# hdd mount path ex) /media/sda1
} app_cfg_t;
