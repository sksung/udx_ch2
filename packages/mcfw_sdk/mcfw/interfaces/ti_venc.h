...
#define VENC_PRIMARY_CHANNELS   (2)

#define VENC_CHN_MAX			(VENC_PRIMARY_CHANNELS*2)    /* for Mjpeg */
...
typedef enum
{
    ...
    VENC_RATECONTROL,
    /**< Get/Set Rate-Control type */

    VENC_ENCPRESET,
    /**< Get/Set Encode Preset Type */

    VENC_PACKETSIZE,
    /**< Get/Set Slice Unit Size */
    ...
    VENC_INPUTKEY,
    /**< Get/Set InputKey for WaterMark */
...
typedef struct
{
    ...
    Int32 rateControl;
    /**< Rate-Control Preset: CBR, VBR and OFF */
