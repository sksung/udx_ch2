...
typedef enum EncDec_ResolutionClass {
	...
	UTILS_ENCDEC_RESOLUTION_CLASS_10MP = UTILS_ENCDEC_RESOLUTION_CLASS_FIRST,
	UTILS_ENCDEC_RESOLUTION_CLASS_8MP,
...
#define UTILS_ENCDEC_RESOLUTION_CLASS_10MP_WIDTH		(3648)
#define UTILS_ENCDEC_RESOLUTION_CLASS_10MP_HEIGHT		(2736)

#define UTILS_ENCDEC_RESOLUTION_CLASS_8MP_WIDTH			(3264)
#define UTILS_ENCDEC_RESOLUTION_CLASS_8MP_HEIGHT		(2448)

#define UTILS_ENCDEC_RESOLUTION_CLASS_5MP_WIDTH			(2560)
#define UTILS_ENCDEC_RESOLUTION_CLASS_5MP_HEIGHT		(1920)
