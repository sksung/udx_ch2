...
#define ENC_LINK_MAX_OUT_FRAMES_PER_CH_NON_D1_RES_CLASS       (SYSTEM_LINK_FRAMES_PER_CH-2)
#define ENC_LINK_MAX_OUT_FRAMES_PER_CH_5M_RES_CLASS       (SYSTEM_LINK_FRAMES_PER_CH-3)
#define ENC_LINK_MAX_OUT_FRAMES_PER_CH_8M_RES_CLASS       (SYSTEM_LINK_FRAMES_PER_CH-4)
#define ENC_LINK_MAX_OUT_FRAMES_PER_CH_10M_RES_CLASS       (SYSTEM_LINK_FRAMES_PER_CH-5)

#define ENC_LINK_MAX_OUT_FRAMES_PER_CH		 (8)//(ENC_LINK_MAX_OUT_FRAMES_PER_CH_D1_RES_CLASS)
...
#define ENC_LINK_DEFAULT_ALGPARAMS_TARGETFRAMERATEX1000                  (30000)//(60000)
#define ENC_LINK_DEFAULT_ALGPARAMS_REFFRAMERATEX1000                     (30000)//(60000)
...
#define ENC_LINK_MAX_FRAME_HEIGHT              (1080)
#endif
...
#define ENCLINK_INFO_LOG(linkID,chID,...)       do {                           \
                                                     Vps_printf(               \
                                                      "\n %d: ENCODE: %s", \
                                                      Utils_getCurTimeInMsec(), __VA_ARGS__); \
                                                } while(0)
#else
