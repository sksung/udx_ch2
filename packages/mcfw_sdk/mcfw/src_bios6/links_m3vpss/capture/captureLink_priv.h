...
#define CAPTURE_VIDEO_DETECT_CHECK_INTERVAL     (500) // in msec
...
typedef struct {
    /* Capture link task */
    Utils_TskHndl tsk;
    Utils_TskHndl tsk_det;		//# for hd sensor detect
    ...
    UInt32    numBlindArea[CAPTURE_LINK_MAX_OUT_QUE][CAPTURE_LINK_MAX_CH_PER_OUT_QUE];
    /**< number of valid blind area for each channel */
    Utils_DmaFill2D blindArea[CAPTURE_LINK_MAX_OUT_QUE]
                [CAPTURE_LINK_MAX_CH_PER_OUT_QUE][CAPTURE_LINK_NUM_BLIND_AREA_PER_CHNL];
...
UInt_64 Capture_walltime_update(CaptureLink_Obj * pObj, UInt_64 cur_time);
