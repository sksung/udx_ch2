...
typedef struct DisplayLink_FrameInfo
{
    ...
    /* This address contains original tiled frame address,
       When orientation is enabled,  */
	UInt32			  chAddr;
	/* Flag to indicate that the addresses are changed */
...
typedef  struct DisplayLink_drvRtParams
{
    ...
    Vps_DeiDispRtParams deiDispRtPrms;
