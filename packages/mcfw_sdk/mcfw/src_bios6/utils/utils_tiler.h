...
/*
0 : 0-degree view
1 : 180-degree view + mirroring
2 : 0-degree view + mirroring
3 : 180-degree view
4 : 270-degree view + mirroring
5 : 270-degree view
6 : 90-degree view
7 : 90-degree view + mirroring
*/
...
#define UTILS_TILER_CNT_8BIT_SWAP_MAX_LINES  (16384u)
#define UTILS_TILER_CNT_16BIT_SWAP_MAX_LINES (16384u)
#define UTILS_TILER_CNT_32BIT_SWAP_MAX_LINES (8192u)
