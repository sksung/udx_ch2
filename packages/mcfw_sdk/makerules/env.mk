...
ifeq ($(UBX_TARGET), UBX_CAR)
  CONFIG_BLD_XDC_m3     = $(MCFW_ROOT_PATH)/mcfw/src_bios6/cfg/ti810x/config_ucx_512M.bld
else
  CONFIG_BLD_XDC_m3     = $(MCFW_ROOT_PATH)/mcfw/src_bios6/cfg/ti810x/config_ubx_512M.bld
endif
endif
endif
